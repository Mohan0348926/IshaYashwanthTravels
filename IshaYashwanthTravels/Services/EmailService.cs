...
<div style=""font-family: Arial, sans-serif; max-width: 600px; margin: auto; border: 1px solid #e0e0e0; border-radius: 8px; overflow: hidden;"">
  <div style=""background: #0b5ed7; padding: 24px; text-align: center;"">
    ...
    <p style=""color: #dbe8ff; margin: 4px 0 0;"">We've received your enquiry 🚐</p>
  </div>
  <div style=""padding: 24px; color: #333; line-height: 1.6;"">
    <p>Dear <strong>{name}</strong>,</p>
    <p>Thank you for contacting <strong>Isha Yaswanth Travels</strong>. We've received your enquiry and our team will get back to you shortly.</p>
    <div style=""background: #f5f8ff; border-left: 4px solid #0b5ed7; padding: 12px 16px; margin: 16px 0; border-radius: 4px;"">
      <p style=""margin: 0;""><strong>Vehicle Type:</strong> {vehicleType}</p>
      <p style=""margin: 4px 0 0;""><strong>Your Message:</strong> {message}</p>
    </div>
  ...
  <div style=""background: #f5f5f5; padding: 12px; text-align: center; font-size: 12px; color: #888;"">
    © Isha Yaswanth Travels
            ...
            var ownerTask = SendAsync(ownerEmail, "New Trip Booking - " + name, ownerHtml);
            var customerTask = SendAsync(email, "We Received Your Enquiry - Isha Yaswanth Travels", customerHtml);
